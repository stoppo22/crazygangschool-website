...
export const faculty = [
  ...
  teacher('claudio-salvatori', 'Claudio', 'Salvatori', 'Insegnante Danza Moderna', 941, 1672, '50% 19%', true),
  ...
  teacher('flavia-fraietta', 'Flavia', 'Fraietta', 'Insegnante Danza Classica e Propedeutica', 1000, 1202, '50% 50%', true),
