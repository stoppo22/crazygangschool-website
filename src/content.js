...
export const faculty = [
  ...
  teacher('dina-serri', 'Dina', 'Serri', 'Insegnante Danza Moderna', 1000, 1250, '50% 20%', true),
  ...
  teacher('angelo-riolo', 'Angelo', 'Riolo', 'Insegnante Kung Fu e Kuai', 1000, 1250, '50% 25%', true),
