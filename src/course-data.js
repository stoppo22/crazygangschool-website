...
export const courses = [
  {
    ...
    schedule: [
      ...
      { name: 'Teenagers / Young', age: '11–15 anni', level: 'Principianti', sessions: [session('Martedì', '19:00', '20:00'), session('Giovedì', '19:00', '20:00')] },
      ...
      { name: 'Over avanz.', age: 'Adulti', sessions: [session('Martedì', '20:00', '21:30')] },
      { name: 'Over princ.', age: 'Adulti', sessions: [session('Giovedì', '20:00', '21:00')] },
    ],
  ...
  },
  {
    ...
    schedule: [
      ...
      { name: 'Professionale', age: '15+ e adulti', sessions: [session('Lunedì', '17:00', '18:00'), session('Mercoledì', '17:00', '18:00')] },
    ],
