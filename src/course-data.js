...
export const courses = [
  {
    ...
    schedule: [
      ...
      { name: 'Panda', age: '8–9 anni', sessions: [session('Martedì', '17:00', '18:00'), session('Giovedì', '17:00', '18:00')] },
  ...
  },
  {
    ...
    metaDescription:
      'Hip hop dai 5 anni compiuti per bambini e ragazzi alla Crazy Gang School di Roma, zona Colli Albani.',
    summary: 'Hip Hop per bambini e ragazzi.',
    ages: ['Bambini e ragazzi: dai 5 anni compiuti'],
    levels: ['Livello non specificato'],
    programs: ['Hip Hop Baby', 'Hip Hop Ragazzi'],
    schedule: [
  ...
  },
  {
    ...
    metaTitle: 'Corso di Salsa, Bachata e Lady Style a Roma — Crazy Gang School',
    metaDescription:
      'Salsa cubana, bachata e lady style per adulti, dal livello base al 2° livello, alla Crazy Gang School di Roma, zona Colli Albani.',
    summary: 'Salsa Cubana, Bachata e Lady Style per adulti, dal livello base al 2° livello.',
    ages: ['Adulti'],
    levels: ['Salsa Cubana: base, 1° e 2° livello', 'Bachata: base e 1° livello'],
    programs: ['Salsa Cubana', 'Bachata', 'Lady Style'],
    schedule: [
