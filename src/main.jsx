    ...
    <main id="contenuto" tabIndex={-1}>
      <section id="inizio" className="hero" aria-labelledby="hero-title">
        <div className="hero-copy">
          <div className="hero-main"><h1 id="hero-title" className="hero-title"><span className="hero-title__line"><span>Dal 1985</span></span><span className="hero-title__line hero-title__line--accent"><span>Crazy Gang School</span></span></h1><p className="hero-subtitle">La tua scuola di danza a Roma!</p><div className="hero-description"><p>Impegno totale, disciplina, rispetto e conoscenza del proprio corpo: un percorso in cui si impara a riconoscere i propri limiti e a superarli, senza accontentarsi mai, costruendo una personalità solida.</p><p>Niente illusioni né protagonismi: umiltà e duro lavoro sono l’unica strada. In tutti questi anni la Crazy Gang School ha formato numerosi professionisti, diventando sempre più sinonimo di eccellenza nella danza e nello spettacolo.</p></div><p className="hero-direction"><span>Direzione artistica:</span>{' '}{faculty.slice(0, 2).map(person => person.name).join(' · ')}</p></div>
      ...
      <section id="discipline" className="disciplines section-space" tabIndex={-1} aria-labelledby="discipline-title">
        <div className="section-heading section-heading--wide reveal"><h2 id="discipline-title">I nostri corsi</h2></div>
