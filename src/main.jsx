    ...
    <main id="contenuto" tabIndex={-1}>
      <section id="inizio" className="hero" aria-labelledby="hero-title">
        <div className="hero-copy">
          ...
          <div className="hero-main"><h1 id="hero-title" className="hero-title"><span className="hero-title__line"><span>Dal 1985 a Roma</span></span><span className="hero-title__line hero-title__line--accent"><span>Crazy Gang School</span></span></h1><p className="hero-direction"><span>Direzione artistica</span>{faculty.slice(0, 2).map(person => person.name).join(' · ')}</p><div className="hero-description"><p>Impegno totale e costante, disciplina, rispetto e conoscenza del proprio corpo: alla Scuola Stopponi si impara a riconoscere i propri limiti e a superarli, a non accontentarsi mai e a costruire una personalità solida, capace di convivere con le proprie emozioni.</p><p>La scuola rifiuta illusioni, protagonismi e superbia: umiltà e duro lavoro sono l’unica strada verso il successo, personale e professionale. In questi anni i fratelli Stopponi hanno formato numerosi professionisti, e il nome Crazy Gang School è sempre più sinonimo di eccellenza nella danza e nello spettacolo.</p></div></div>
